...
class Contacts_Email_Phone(unittest.TestCase):
    ...
    def test_05_email_new(self):
        ...
        self.assertTrue(CustomerRecordPage(self.driver).new_email("New","uiautomation@qq.com","Business","false"))
    ...
    def test_07_email_edit(self):
        ...
        self.assertTrue(CustomerRecordPage(self.driver).operator_email("Edit","uiautomationEdit@qq.com", "Company", "true"))
    ...
    def test_10_phone_new(self):
        ...
        self.assertTrue(CustomerRecordPage(self.driver).operator_phone("Edit","1","Fax","111","1234567","666"))
    ...
    def test_12_phone_edit(self):
        ...
        self.assertTrue(CustomerRecordPage(self.driver).operator_phone("Edit", "2", "Home", "666", "6666666", "111"))
