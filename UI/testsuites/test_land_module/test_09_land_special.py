...
class landSummary(unittest.TestCase):
    ...
    def test_01_countySeat(self):
        ...
        LandCommonPage(self.driver).summary_operation("Land Details","Location From County Seat", "Edit", "","")
    ...
    def test_02_countySeat_history(self):
      ...
      self.assertTrue(LandCommonPage(self.driver).summary_operation("Land Details","Location From County Seat","History",1,1))
    ...
    def test_03_location(self):
        ...
        LandCommonPage(self.driver).summary_operation("Land Details","Location", "Edit", "","")
    ...
    def test_04_location_history(self):
      u"""location History"""
      self.assertTrue(LandCommonPage(self.driver).summary_operation("Land Details","Location","History",1,1))
    ...
    def test_05_characteristic(self):
        ...
        LandCommonPage(self.driver).summary_operation("Land Details","Characteristics", "Edit", "","")
    ...
    def test_06_characteristic_history(self):
      ...
      self.assertTrue(LandCommonPage(self.driver).summary_operation("Land Details","Characteristics","History",1,1))
    ...
    def test_07_dispositionPlan_new(self):
        ...
        LandCommonPage(self.driver).summary_operation("Land Details","Disposition Attributes", "New", "","")
    ...
    def test_08_dispositionPlan_details(self):
        ...
        self.assertTrue(LandCommonPage(self.driver).summary_operation("Land Details","Disposition Attributes","Details",1,1))

    def test_09_dispositionPlan_history(self):
        u"""dispositionPlan history"""
        self.assertTrue(LandCommonPage(self.driver).summary_operation("Land Details", "Disposition Attributes", "History", 1, 1))

    def test_10_dispositionPlan_edit(self):
        u"""edit dispositionPlan"""
        dispositionAttribute = dbConnect().getdata(*(excelHandle(filepath,sheetName).read_excel("dispositionAttribute")))
        LandCommonPage(self.driver).summary_operation("Land Details","Disposition Attributes", "Edit", "1","")
    ...
    def test_11_dispositionPlan_delete(self):
        ...
        LandCommonPage(self.driver).summary_operation("Land Details","Disposition Attributes", "Delete", "1","")
        self.assertTrue(LandCommonPage(self.driver).delete())

    def test_12_improvement_required(self):
        u"""improvement required"""
        LandCommonPage(self.driver).summary_operation("Land Details","Improvements", "New", "","")
    ...
    def test_14_improvement_details(self):
      ...
      self.assertTrue(LandCommonPage(self.driver).summary_operation("Land Details","Improvements","Details",1,1))

    def test_15_improvement_history(self):
        u"""improvement history"""
        self.assertTrue(LandCommonPage(self.driver).summary_operation("Land Details", "Improvements", "History", 1, 1))

    def test_16_improvement_edit(self):
        u"""edit improvement"""
        improvementType = dbConnect().getdata(*(excelHandle(filepath,sheetName).read_excel("improvementType")))
        LandCommonPage(self.driver).summary_operation("Land Details","Improvements", "Edit", "1","")
        self.assertTrue(LandDetailPage(self.driver).improvement(improvementType))

    def test_17_improvement_delete(self):
        u"""delete improvement"""
        LandCommonPage(self.driver).summary_operation("Land Details","Improvements", "Delete", "1","")
        self.assertTrue(LandCommonPage(self.driver).delete())

    def test_18_encumbrance_new(self):
        u"""New encumbrance"""
        LandCommonPage(self.driver).summary_operation("Land Details", "Encumbrances", "New", "", "")
    ...
    def test_19_encumbrance_details(self):
      u"""encumbrance Details"""
      self.assertTrue(LandCommonPage(self.driver).summary_operation("Land Details","Encumbrances","Details",1,1))

    def test_20_encumbrance_history(self):
        u"""encumbrance history"""
        self.assertTrue(LandCommonPage(self.driver).summary_operation("Land Details", "Encumbrances", "History", 1, 1))

    def test_21_encumbrance_edit(self):
        u"""edit encumbrance"""
        encumbranceClass = dbConnect().getdata(*(excelHandle(filepath,sheetName).read_excel("encumbranceClass")))
        LandCommonPage(self.driver).summary_operation("Land Details","Encumbrances", "Edit", "1","")
        self.assertTrue(LandDetailPage(self.driver).encumbrance(encumbranceClass))

    def test_22_encumbrance_delete(self):
        u"""delete encumbrance"""
        LandCommonPage(self.driver).summary_operation("Land Details","Encumbrances", "Delete", "1","")
        self.assertTrue(LandCommonPage(self.driver).delete())

    def test_23_surroundingUse_new(self):
        u"""New surroundingUse"""
        surroundingUseClass = dbConnect().getdata(*(excelHandle(filepath,sheetName).read_excel("surroundingUseClass")))
        LandCommonPage(self.driver).summary_operation("Land Details", "Surrounding Use", "New", "", "")
        self.assertTrue(LandDetailPage(self.driver).surroundingUse(surroundingUseClass))

    def test_24_surroundingUse_details(self):
      u"""surroundingUse Details"""
      self.assertTrue(LandCommonPage(self.driver).summary_operation("Land Details","Surrounding Use","Details",1,1))

    def test_25_surroundingUse_history(self):
        u"""surroundingUse history"""
        self.assertTrue(LandCommonPage(self.driver).summary_operation("Land Details", "Surrounding Use", "History", 1, 1))

    def test_26_surroundingUse_edit(self):
        u"""edit surroundingUse"""
        surroundingUseClass = dbConnect().getdata(*(excelHandle(filepath,sheetName).read_excel("surroundingUseClass")))
        LandCommonPage(self.driver).summary_operation("Land Details","Surrounding Use", "Edit", "1","")
        self.assertTrue(LandDetailPage(self.driver).surroundingUse(surroundingUseClass))

    def test_27_surroundingUse_delete(self):
        u"""delete surroundingUse"""
        LandCommonPage(self.driver).summary_operation("Land Details","Surrounding Use", "Delete", "1","")
        self.assertTrue(LandCommonPage(self.driver).delete())

    def test_28_utilities_required(self):
        u"""utilities required"""
        LandCommonPage(self.driver).summary_operation("Land Details","Utilities", "New", "","")
        self.assertTrue(LandCommonPage(self.driver).required_validation())
    ...
    def test_30_utilities_details(self):
      u"""utilities Details"""
      self.assertTrue(LandCommonPage(self.driver).summary_operation("Land Details","Utilities","Details",1,1))

    def test_31_utilities_history(self):
        u"""utilities history"""
        self.assertTrue(LandCommonPage(self.driver).summary_operation("Land Details", "Utilities", "History", 1, 1))

    def test_32_utilities_edit(self):
        u"""edit utilities"""
        utilityType = dbConnect().getdata(*(excelHandle(filepath,sheetName).read_excel("utilityType")))
        LandCommonPage(self.driver).summary_operation("Land Details","Utilities", "Edit", "1","")
        self.assertTrue(LandDetailPage(self.driver).utilities(utilityType))

    def test_33_utilities_delete(self):
        u"""delete utilities"""
        LandCommonPage(self.driver).summary_operation("Land Details","Utilities", "Delete", "1","")
        self.assertTrue(LandCommonPage(self.driver).delete())
