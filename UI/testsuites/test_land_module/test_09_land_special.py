...
class landDetailsSpecial(unittest.TestCase):
    ...
    def test_12_improvement_required(self):
        ...
        LandCommonPage(self.driver).entity_operator("Land Details","Improvements", "New", "","")
    ...
    def test_18_encumbrance_required(self):
        ...
        LandCommonPage(self.driver).entity_operator("Land Details","Encumbrances", "New", "","")
        self.assertTrue(LandCommonPage(self.driver).required_validation())
    ...
    def test_24_surroundingUse_required(self):
        u"""surroundingUse required"""
        LandCommonPage(self.driver).entity_operator("Land Details","Surrounding Use", "New", "","")
        self.assertTrue(LandCommonPage(self.driver).required_validation())

    def test_25_surroundingUse_new(self):
